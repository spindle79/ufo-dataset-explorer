...
export default function CsvUploadTab({ onUploadSuccess }: CsvUploadTabProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('/api/pdf/csv', {
        method: 'POST',
        body: formData,
      });
    ...
    <div>
      <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md">
        ...
        <p className="text-sm text-blue-800 dark:text-blue-300">
          ...
          Expected format: <code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">url</code> or <code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">pdf_url</code> or <code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">link</code>
        </p>
      </div>
