...
/**
 * GET /api/pdf/[id]/generations
 * Get all AI generations for a PDF file
 */
export async function GET(
  ...
  try {
    ...
    if (generationType) {
      ...
      // Get all extraction-related generations
      query = query.like("generation_type", "extraction-%");
    }
