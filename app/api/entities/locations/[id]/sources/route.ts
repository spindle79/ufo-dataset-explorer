/**
 * API Route: Get source items for a location
 * GET /api/entities/locations/[id]/sources
 */
...
export async function GET(
  ...
  try {
    ...
    // Get all relationships for this location
    ...
    console.error("Error fetching location sources:", error);
    return NextResponse.json(
      {
        error: "Failed to fetch location sources",
        message:
