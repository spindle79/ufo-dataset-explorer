...
import { Loader2, ExternalLink, FileText, Music, Video, File, Users, Info } from "lucide-react";
...
export default function PersonDetailPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        // Fetch person
        const personResponse = await fetch(`/api/entities/people/${id}`);
        ...
        // Fetch sources
        const sourcesResponse = await fetch(`/api/entities/people/${id}/sources`);
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
              ...
              {sources.length === 0 ? (
                <p className="text-gray-500 dark:text-gray-400">
                  No source items found. This person has not been extracted from any documents yet.
                </p>
              ) : (
